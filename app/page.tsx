...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <h2 className='openingDescription'>This exercise will walk you through what it is like living in a scarcity mindset; 
      ...
      how it may be for someone that is living with abundance. 
      It is important to learn what a scarcity mindset is like so that we can empathise with clients.</h2>
